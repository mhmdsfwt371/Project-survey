...
/* السقفُ يهبط ولا يصعد: ٤١ نصًّا قبل V17.60 ثم ٣١ بعد أن صارت حقولُ شاشة الأنواع
   تُوسَم باسم النوع المترجَم — والهامشُ نصّان كما كان */
const CAP_PAGES = 11, CAP_TEXTS = 33, CAP_SHELL = 2;
let bad = 0;
