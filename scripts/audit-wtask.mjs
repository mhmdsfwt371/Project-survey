...
T(all[0].length === 17 && all[0][1] === 'المهمة' && all[0][14] === 'توقف المهمة' && all[0][16] === 'اجتماع الاربعاء',
  'وورقةُ العمل بمواضع أعمدةِ ملفِّ المكتب — يقرؤها الاستيرادُ من أيِّ الورقتين');
