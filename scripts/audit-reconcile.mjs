...
T(after(over, 'إجمالي المواقع') === TOTAL && after(sv, 'الكل') === N_REC, 'الإجماليُّ هو الإجمالي — والسجلُّ يعدُّ سجلاتِه: ' + TOTAL + ' / ' + N_REC);
T(after(over, 'تم المسح') === SURVEYED && after(sv, 'مُسح') === SURVEYED && ch('sv') === SURVEYED && after(svd, 'نقاطٌ مُسحت') === SURVEYED,
  'المسحُ رقمٌ واحدٌ في أربع شاشات: ' + SURVEYED);
T(after(over, 'متعذّر') === N_STUCK && after(sv, 'متعذّر') === N_STUCK, 'والمتعذّرُ رقمٌ واحدٌ في الملخّص وشاشة المسح: ' + N_STUCK);
T(after(sv, 'تحتاج زيارة أخرى') === N_REV, 'والمردودُ يُعَدُّ وحدَه في شاشة المسح: ' + N_REV);
T(after(over, 'مُركّب') === N_INS && ch('ins') === N_INS, 'والمُركَّبُ رقمٌ واحدٌ في الملخّص والسلسلة: ' + N_INS);
T(after(over, 'لم يُزر') === NOT_VISITED && after(sv, 'لم يُزر') === NOT_VISITED, 'و«لم يُزر» = المواقعُ − السجلات: ' + NOT_VISITED);
