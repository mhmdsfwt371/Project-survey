...
/* V16.48: السقفُ يهبط مع كلِّ تنظيف — والهامشُ خمسةٌ لا واحد، فلا يسقط
   السيرُ لأن سطرًا جديدًا أُضيف. من زاد عليه يُعطي أثرًا أو ينظّف غيرَه. */
const CAP_EMPTY = 39;   /* الهامشُ خمسةٌ فوق أربعةٍ وثلاثين — فلا يسقط السيرُ لسطرٍ جديد */
