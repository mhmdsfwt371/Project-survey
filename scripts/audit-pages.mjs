...
const STATIC_OK = {
  ...
  moh:       'واجهةُ الوزارة — غلافٌ يوجّه لصفحاتٍ أخرى',
  mohRep:    'تقاريرُ الوزارة — فهرسٌ يوجّه للتصدير',
  acct:      'حسابي — يقرأ STATE.meta عبر غلافٍ لا يطابق النمط',
  setup:     'المواعيدُ والأزمنة — تُقرأ من CFG عبر cfgGet بأسماءٍ مركّبة',
  creps:     'التقاريرُ الدورية — تُقرأ من PERIODS وCFG.crTime',
