...
/* (V17.96) وتنبيهُ الميزانية في Google Cloud قرارُ إنسانٍ كذلك — يُؤشِّره المدير */
T(rdy.length<=7 && rdy.every(x=>/سعرُ النقطة|الميزانية|خطُّ الأساس|المعتمِدين|المركَّبة|الاحتياطية/.test(x)),
