...
## ١ · الفكرةُ الحاكمة
ملفٌّ واحدٌ يعمل بلا شبكة على هاتف الفنيّ، وقاعدةٌ واحدةٌ تُزامَن حين تعود الشبكة، ولا خادمَ خاصًّا: الأتمتةُ كلُّها في GitHub Actions. كلُّ رقمٍ يُعرَض له تعريفٌ واحدٌ في الشيفرة (`lifeOf` · `siteKeyStats`) تحرسه الجرود.
